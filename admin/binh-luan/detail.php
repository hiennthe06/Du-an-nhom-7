          ...
          <i class="hamburger align-self-center"></i>
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<div class="mb-3">
						<h1 class="h3 d-inline align-middle">Bình luận sản phẩm</h1>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <tr>
                    ...
                    <td>' . $key['ma_kh'] . '</td>
                    <td><a href="./index.php?action=binh-luan&page=edit&&ma_bl=' . $key['ma_bl'] . '&ma_hh=' . $key['ma_hh'] . '" class="btn btn-primary">sửa</a></td>
