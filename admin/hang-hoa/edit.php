...
<head>
	...
	<link rel="shortcut icon" href="../content/img/icons/icon-48x48.png" />
      ...
      <i class="align-middle" data-feather="book"></i> <span class="align-middle">Thống kê</span>
		...
		<div class="main">
          ...
          <i class="hamburger align-self-center"></i>
							...
							<div class="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0" aria-labelledby="messagesDropdown">
								...
								<div class="list-group">
									<a href="#" class="list-group-item">
										<div class="row g-0 align-items-center">
											<div class="col-2">
												<img src="../content/img/avatars/avatar-5.jpg" class="avatar img-fluid rounded-circle" alt="Vanessa Tucker">
											</div>
									...
									<a href="#" class="list-group-item">
										<div class="row g-0 align-items-center">
											<div class="col-2">
												<img src="../content/img/avatars/avatar-2.jpg" class="avatar img-fluid rounded-circle" alt="William Harris">
											</div>
											<div class="col-10 ps-2">
									...
									<a href="#" class="list-group-item">
										<div class="row g-0 align-items-center">
											<div class="col-2">
												<img src="../content/img/avatars/avatar-4.jpg" class="avatar img-fluid rounded-circle" alt="Christina Mason">
											</div>
											<div class="col-10 ps-2">
									...
									<a href="#" class="list-group-item">
										<div class="row g-0 align-items-center">
											<div class="col-2">
												<img src="../content/img/avatars/avatar-3.jpg" class="avatar img-fluid rounded-circle" alt="Sharon Lessman">
											</div>
											<div class="col-10 ps-2">
                ...
                <img src="../content/img/avatars/avatar.jpg" class="avatar img-fluid rounded me-1" alt="Charles Hall" /> <span class="text-dark">Charles Hall</span>
              </a>
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<div class="mb-3">
						<h1 class="h3 d-inline align-middle">Sửa hàng hóa</h1>
...
?> 
<form class="form-horizontal" action="?action=hang-hoa&page=edit" method="POST" enctype="multipart/form-data">
<div class="card-body">
    <div class="card">
        <div class="form-group">
          <label for=""></label>
          <b id="helpId" class="text-muted">Mã hàng hóa</b>
          <input type="text" name="room_id" id="" class="form-control" placeholder="" aria-describedby="helpId" value="<?php echo $data['hang_list']['room_id']?>" readonly>        
        </div>
        
		<div class="form-group">
          <label for=""></label>
          <b id="helpId" class="text-muted">Đơn giá</b>
          <input type="text" name="room_price1" id="" class="form-control" placeholder="" value="<?php echo $data['hang_list']['room_price']?>" aria-describedby="helpId">        
        </div>

        <div class="form-group">
          <label for=""></label>
          <b id="helpId" class="text-muted">Giảm giá</b>
          <input type="text" name="room_discount" id="" class="form-control" placeholder="" value="<?php echo $data['hang_list']['room_discount']?>" aria-describedby="helpId">        
        </div>
        
		<div class="form-group">
          <label for=""></label>
          <b id="helpId" class="text-muted">Hình ảnh</b>         
          <input type="file" class="form-control-file border" name="room_image">     
        </div>

		<div class="form-group">
			<label for="comment"><b>Mô tả</b></label>
			<textarea class="form-control" rows="5" id="comment" name="room_describe"><?php echo $data['hang_list']['room_describe']?></textarea>
    	</div>

		<div class="form-group">
          <label for=""></label>
          <b id="helpId" class="text-muted">Số lượt xem</b>
          <input type="text" name="room_price" id="" class="form-control" placeholder="" value="<?php echo $data['hang_list']['room_view']?>" aria-describedby="helpId" readonly>        
        </div>
				...
				<div class="container-fluid">
					<div class="row text-muted">
						<div class="col-6 text-start">
							<p class="mb-0">
								<a class="text-muted" href="https://adminkit.io/" target="_blank"><strong>AdminKit</strong></a> - <a class="text-muted" href="https://adminkit.io/" target="_blank"><strong>Nguyễn Thế Hiển</strong></a>								&copy;
							</p>
						</div>
