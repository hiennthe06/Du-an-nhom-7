...
<body>
          ...
          <i class="hamburger align-self-center"></i>
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<div class="mb-3">
						<h1 class="h3 d-inline align-middle">Thêm loại hàng</h1>
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card">
          <form class="form-horizontal" action="?action=loai-hang&page=new" method="POST">
            <div class="card-body">

              <div class="form-group">
                <label for=""></label>
                <b id="helpId" class="form-text text-muted">Mã loại</b>
                <input type="text" class="form-control" name="" id="" aria-describedby="helpId" placeholder="Không nhập mục này" readonly>
              </div>
              <div class="form-group">
                <label for=""></label>
                <b id="helpId" class="form-text text-muted">Tên loại</b>
                <input type="text" class="form-control" name="type_name" id="" required="required" aria-describedby="helpId" placeholder="">
              </div>
              <br><br>
