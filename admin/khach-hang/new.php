          ...
          <i class="hamburger align-self-center"></i>
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<div class="mb-3">
						<h1 class="h3 d-inline align-middle">Thêm khách hàng</h1>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    ?>
                    <form class="form-horizontal" action="?action=khach-hang&page=new" method="POST" enctype="multipart/form-data">
                        <div class="card-body">
                            ...
                            <div class="card">
                                <div class="">
									...
									<div class="form-group">
                                        <label for=""></label>
                                        <b id="helpId" class="text-muted">Số điện thoại</b>
                                        <input type="text" name="sdt" id="" required="required" class="form-control" placeholder="" aria-describedby="helpId">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for=""></label>
                                        <b id="helpId" class="text-muted">Thanh toán</b><br>
                                        <div class="form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" required="required" name="kich_hoat" value="0">Chưa thanh toán
                                            </label>
                                        </div>
                                        <div class="form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" required="required" name="kich_hoat" value="1">Đã thanh toán
                                            </label>
                                        </div>
                                    </div>
									...
									<div class="form-group">
                                        <label for=""></label>
                                        <b id="helpId" class="text-muted">Vai trò của bạn ?</b><br>
                                        <div class="form-check-inline">
                                            <label class="form-check-label">
