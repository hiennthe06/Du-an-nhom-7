          ...
          <i class="hamburger align-self-center"></i>
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<div class="mb-3">
						<h1 class="h3 d-inline align-middle">Sửa khách hàng</h1>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    ?>
                    <form class="form-horizontal" action="?action=khach-hang&page=edit" method="POST">
                        <div class="card-body">
                            <div class="card">
                                <div class="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="sdt" id="" class="form-control" placeholder="" value="<?php echo $data['khach_list']['sdt'] ?>" aria-describedby="helpId">
                                    </div>
